...
from ..items import CloudmusicItem
...
class CloudMusicSpider(scrapy.Spider):
    ...
    def parse_artist_pre(self, response):
        ...
        if artist_albums == []:  # 若为空，说明只有一页，即套用原parse_artist方法的代码，注意callback=self.parse_album
            ...
            for artist_album in artist_albums:
                ...
                yield scrapy.Request(artist_album_url, callback=self.parse_artist)
    ...
    def parse_album(self, response):
        ...
        for music in musics:
            ...
            yield scrapy.Request(music_url, meta={'id': music_id}, callback=self.parse_music)
    ...
    def parse_music(self, response):
        ...
        yield scrapy.FormRequest(music_comment, meta={'id': music_id, 'music': music, 'artist': artist, 'album': album}, \
